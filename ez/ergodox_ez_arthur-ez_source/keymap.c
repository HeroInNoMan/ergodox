...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, LALT(KC_F4),    KC_MS_WH_LEFT,  KC_TRANSPARENT, KC_MS_WH_RIGHT, KC_MS_BTN5,     KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_MEDIA_PREV_TRACK,KC_SCROLLLOCK,  KC_MEDIA_NEXT_TRACK,KC_TRANSPARENT, KC_F14,
  ...
  [3] = LAYOUT_ergodox_pretty(
    ...
    KC_DOT,         KC_H,           KC_SCOLON,      KC_O,           KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    ...
                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_F4,          TO(0),          KC_TRANSPARENT, KC_TRANSPARENT
  ),
};
